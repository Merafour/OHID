...
//        sn[3] = '-';
//        for(cnt=0; cnt<16; cnt++) sn[cnt+4] = hex2str[SN[cnt]&0x0F];
//		return 20;
//    }
//    else 
//    {
//        for(cnt=0; cnt<16; cnt++) sn[cnt] = hex2str[SN[cnt]&0x0F];
//		return 16;
//    }
	sn[0] = 'E';
	sn[1] = hex2str[((bl_code>>4)&0x0F)];
	...
	//for(uint8_t cnt=0+4; cnt<16+4; cnt++) sn[cnt] = hex2str[sn[cnt]&0x0F];   // 数字转字符
	sn[16+4] = '\0';
	return 20;
}
...
//void uid_convert_sn_str(const uint8_t id[12], char sn[22])
//{
//	sn[0] = 'E';
//	sn[1] = hex2str[((bl_code>>4)&0x0F)];
//	sn[2] = hex2str[((bl_code>>0)&0x0F)];
