...
USBD_ClassTypeDef  USBD_CUSTOM_HID =
{
  ...
  NULL,
  NULL,
  USBD_CUSTOM_HID_GetFSCfgDesc,//USBD_CUSTOM_HID_GetHSCfgDesc,
  USBD_CUSTOM_HID_GetFSCfgDesc,
  USBD_CUSTOM_HID_GetFSCfgDesc,//USBD_CUSTOM_HID_GetOtherSpeedCfgDesc,
...
/**
  ...
  * @retval status
  */
__weak void bl_receive(const uint8_t Recv[64])
{
	;
}
static uint8_t USBD_CUSTOM_HID_DataOut(USBD_HandleTypeDef *pdev, uint8_t epnum)
